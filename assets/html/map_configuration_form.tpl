	<fieldset class="fieldset">
		...
		<table class="cgmp-widget-table" cellspacing="0" cellpadding="0" border="0">
			<tbody>
				<tr>
					<td><a id="tooltip-marker-width" class="google-map-tooltip-marker" href="javascript:;" title="Width of map placeholder DIV">[Help?]</a>&nbsp;LABEL_WIDTH</td>
					<td>INPUT_WIDTH</td>
					<td><a id="tooltip-marker-height" class="google-map-tooltip-marker" href="javascript:void(0);" title="Height of map placeholder DIV">[Help?]</a>&nbsp;LABEL_HEIGHT</td>
					<td>INPUT_HEIGHT</td>
				</tr>
				<tr>
				...
				<tr>
					<td><a id="tooltip-marker-mapalign" class="google-map-tooltip-marker" href="javascript:void(0);" title="Controls alignment of the generated map on the screen: LEFT, RIGHT or CENTER">[Help?]</a>&nbsp;LABEL_MAPALIGN</td>
					<td>SELECT_MAPALIGN</td>
					<td><a id="tooltip-marker-mapalign" class="google-map-tooltip-marker" href="javascript:void(0);" title="Hint message displayed above the map, telling users if they want to get directions, they should click on map markers. ATM its in English, sorry :( Localization will come soon!">[Help?]</a>&nbsp;LABEL_DIRECTIONHINT</td>
	...
	<fieldset class="fieldset"  class="collapsible">
		...
		<table class="cgmp-widget-table" cellspacing="0" cellpadding="0" border="0">
			<tbody>
				<tr>
					<td><a id="tooltip-marker-maptypecontrol" class="google-map-tooltip-marker" href="javascript:void(0);" title="The MapType control lets the user toggle between map types (such as ROADMAP and SATELLITE). This control appears by default in the top right corner of the map">[Help?]</a>&nbsp;LABEL_M_APTYPECONTROL</td>
	...
	<fieldset class="fieldset"  class="collapsible">
		...
		<table class="cgmp-widget-table" cellspacing="0" cellpadding="0" border="0">
			<tbody>
				<tr>
					<td><a id="tooltip-marker-bubbleautopan" class="google-map-tooltip-marker" href="javascript:void(0);" title="Enables or disables info bubble auto-panning (the map view centers on the info bubble) when marker is clicked">[Help?]</a>&nbsp;LABEL_BUBBLEAUTOPAN</td>
	...
	<fieldset class="fieldset" class="collapsible">
		...
		<table class="cgmp-widget-table" cellspacing="0" cellpadding="0" border="0">
			<tbody>
				<tr>
					<td><a id="tooltip-marker-showbike" class="google-map-tooltip-marker" href="javascript:void(0);" title="A layer showing bike lanes and paths as overlays on a Google Map">[Help?]</a>&nbsp;LABEL_SHOWBIKE</td>
					<td>SELECT_SHOWBIKE</td>
					<td><a id="tooltip-marker-showtraffic" class="google-map-tooltip-marker" href="javascript:void(0);" title="A layer showing vehicle traffic as overlay on a Google Map">[Help?]</a>&nbsp;LABEL_SHOWTRAFFIC</td>
		...
		<table class="cgmp-widget-table" cellspacing="0" cellpadding="0" border="0">
			<tbody>
				<tr>
					...
					<td><a id="tooltip-marker-panoramiouid" class="google-map-tooltip-marker" href="javascript:void(0);" title="If specified, the Panoramio photos displayed on the map, will be filtered based on the specified user ID. Please provide NUMERIC user ID only! NOT the Panoramio user web URL!">[Help?]</a>&nbsp;LABEL_PANORAMIOUID</td>
