...
b.postTitle+"' href='"+b.postLink+"'>"+l+"..</a></p>"),e=e+("<p class='geo-mashup-post-excerpt'>"+b.postExcerpt+"</p>");else{e=e+("<h4>"+d.address+":</h4>");e=e+("<p class='custom-bubble-text'>"+a+"</p>");b.customBubbleText!=""&&(e=e+("<p class='custom-bubble-text'>"+b.customBubbleText+"</p>"))}e=e+"<hr />"+("<p class='custom-bubble-text'>"+d.directions+": <a id='toHere-"+c+"' class='dirToHereTrigger' href='javascript:void(0);'>"+d.toHere+"</a> - <a id='fromHere-"+c+"' class='dirFromHereTrigger' href='javascript:void(0);'>"+
d.fromHere+"</a> | <a id='trigger-"+c+"' class='streetViewTrigger' href='javascript:void(0);'>"+d.streetView+"</a></p>");return{bubbleHolderId:c,bubbleContent:e+"</div>"}}function P(b,c){var h=1;a.each(b,function(){if(this.excerpt==null)this.excerpt="";var a=this.addy.split(I);a[0]=this.location;p(h,a,this.title,this.permalink,this.excerpt,c);h++});s.info("Have "+(h-1)+" destinations for marker Geo mashup..")}function o(a,b,c,e,d,l){b[2]!=null?b[2].indexOf("No description provided")!=-1&&(b[2]=""):
b[2]="";F.push({address:b[0],animation:google.maps.Animation.DROP,zIndex:a,markerIcon:b[1],customBubbleText:b[2],postTitle:c,postLink:e,postExcerpt:d,geoMashup:l})}function p(a,b,c,e,d,l){var g=[];b[0].indexOf(",")!=-1?g=b[0].split(","):b[0].indexOf(";")!=-1&&(g=b[0].split(";"));if(g.length==0)return false;g[0]=n.trim(g[0]);g[1]=n.trim(g[1]);if(g[0]==""||g[1]=="")return false;b[0]=new google.maps.LatLng(parseFloat(g[0]),parseFloat(g[1]));o(a,b,c,e,d,l)}function z(){clearTimeout(G);if(F.length>0){var b=
F.shift();b.address instanceof google.maps.LatLng?v(b):T.geocode({address:b.address},function(a,c){D(a,c,b)})}else{q();if(H.length>0){var c="";a.each(H,function(a,b){c=c+("&nbsp;&nbsp;&nbsp;<b>"+(1+a)+". "+b+"</b><br />")});E.alertError(i.badAddresses.replace("[REPLACE]",c))}H=[]}}function q(){if(A.length>1){a.each(A,function(a,b){B.contains(b.position)||B.extend(b.position)});x=B;B!=null&&k.fitBounds(B)}else if(A.length==1){k.setCenter(A[0].position);M=k.getZoom();K=k.getCenter()}}function v(a){var b=
a.address;a.address="Lat/Long: "+b.lat().toFixed(6)+", "+b.lng().toFixed(6);U(b,a);z()}function D(a,b,c){if(b==google.maps.GeocoderStatus.OK){U(a[0].geometry.location,c);G=setTimeout(function(){z()},330)}else if(b==google.maps.GeocoderStatus.OVER_QUERY_LIMIT){q();F.push(c);G=setTimeout(function(){z()},3E3)}else if(b==google.maps.GeocoderStatus.ZERO_RESULTS){H.push(c.address);G=setTimeout(function(){z()},400)}}function U(c,d){var h=new google.maps.Marker({position:c,title:d.address.replace("<br />",
" :: "),content:d.address,zIndex:d.zIndex+1E3,map:k});if(h){if(d.markerIcon){var e=d.markerIcon;if(typeof e=="undefined"||e==="undefined")e="1-default.png";h.setIcon(r+e);var g=null,g=["4-default.png","5-default.png","6-default.png","7-default.png"];if(a.inArray(e,["1-default.png","2-default.png"])!=-1){e=r+"msmarker.shadow.png";g=L(e,59,32,0,0,16,33)}else if(a.inArray(e,g)!=-1){e=r+"msmarker.shadow.png";g=L(e,59,32,0,0,21,34)}else if(e.indexOf("3-default")!=-1){e=r+"beachflag_shadow.png";g=L(e,37,
32,0,0,10,33)}else g=L(r+"shadow.png",68,37,0,0,32,38);h.setShadow(g)}b(h,d);if(!N){J();N=true}A.push(h)}}function L(a,b,c,e,d,g,l){return new google.maps.MarkerImage(a,new google.maps.Size(b,c),new google.maps.Point(e,d),new google.maps.Point(g,l))}var A,F,H,O,G,N,k,C,Q,x,K,M,t,T,B,u,R,y,S;return{init:function(a,b){k=a;t=k.getDiv().id;Q=b;google.maps.event.addListener(k,"click",function(){l()});A=[];H=[];F=[];M=5;x=K=C=G=null;O=N=false;T=new google.maps.Geocoder;B=new google.maps.LatLngBounds;u=
new google.maps.InfoWindow;R=new google.maps.StreetViewService;S=new google.maps.DirectionsService;rendererOptions={draggable:true};y=new google.maps.DirectionsRenderer(rendererOptions);y.setPanel(document.getElementById("rendered-directions-placeholder-"+t))},buildAddressMarkers:function(a,b,c){O=true;C=n.trim(a);C=n.searchReplace(C,"'","");if(b==="true"){a=w(C);c==="true"?P(a,true):c==="false"&&P(a,false);z()}else if(b==null||b==="false"){c=C.split("|");for(a=0;a<c.length;a++){var e=c[a];if(e!=
null&&e!=""){e=n.trim(e);if(e!=""){b=a+1;e=e.split(I);if(n.isNumeric(e[0]))p(b,e,"","","",false);else{n.isAlphaNumeric(e[0]);o(b,e,"","","",false)}}}}z()}},isBuildAddressMarkersCalled:function(){return O}}},n=function(){return{isNumeric:function(a){return/^([0-9?(\-.,;\s{1,})]+)$/.test(a)},isAlphaNumeric:function(a){return/^([a-zA-Z0-9?(/\-.,\s{1,})]+)$/.test(a)},trim:function(a){return a.replace(/^\s+|\s+$/g,"")},searchReplace:function(a,c,b){return a.replace(RegExp(c,"g"),b)}}}(),s=function(){var d=
function(c){a.browser.msie||(a.browser.mozilla&&parseInt(a.browser.version)>=1?console.log(c):a.browser.webkit&&parseInt(a.browser.version)>=534?console.log(c):a.browser.opera&&parseInt(a.browser.version)>=11&&console.log(c))};return{info:function(a){d("Info :: "+a)},raw:function(a){d(a)},warn:function(a){d("Warning :: "+a)},error:function(a){d("Error :: "+a)},fatal:function(a){d("Fatal :: "+a)}}}(),E=function(){return{alertError:function(d){function c(b,c){b.preventDefault();var d=a(c).closest("div.cgmp-popup-shortcode-dialog");
d&&a(d).remove();a("div.cgmp-popup-shortcode-dialog").length==0&&a("#cgmp-popup-mask").remove()}var b=a('<div id="cgmp-popup-mask"/>'),i=Math.random().toString(36).substring(3),g=a('<div id="'+i+'" class="cgmp-popup-shortcode-dialog cgmp-popup-window">');g.html("<div class='dismiss-container'><a class='dialog-dismiss' href='javascript:void(0)'>\u00d7</a></div><p style='text-align: left; padding: 10px 10px 0 10px'>"+d+"</p><div align='center'><input type='button' class='close-dialog' value='Close' /></div>");
